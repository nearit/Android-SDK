...
[![CircleCI](https://circleci.com/bb/Synapsev2/android-sdk/tree/master.svg?style=svg)](https://circleci.com/bb/Synapsev2/android-sdk/tree/master)
...
```java
dependencies {
    compile 'it.near.sdk:nearit:2.4.1'
}
```
